...
\begin{theorem}\label{theorem:V}
	For a function $g$ defined on $\mathcal{P}_n$ which can depend on $\bm{\rho}^0$, for any $n$,
...
\begin{figure}[h!]
		...
		\centering
		\includegraphics[width=\textwidth]{figures/Mallows_alpha1N200n10run1.pdf}
		
	\end{minipage}
	\hfill
	\begin{minipage}[t]{.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/Pseudo_alpha1N200n10run1.pdf}
...
\subfigure[]{
	...
	\begin{minipage}[t]{.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/Mallows_alpha1dot5N200n10run1.pdf}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/Pseudo_alpha1dot5N200n10run1.pdf}
	\end{minipage}  
...
\subfigure[]{	
	\begin{minipage}[t]{.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/Mallows_alpha2N200n10run1.pdf}
	\end{minipage}
	\hfill
	\begin{minipage}[t]{.4\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figures/Pseudo_alpha2N200n10run1.pdf}
	\end{minipage}  
	
}
	
\caption{left column: Mallows, right column: pseudolikelihoods. $N = 200, n = 10$, $\alpha^0 = 1, 1.5, 2$ respectively, from top to bottom}
\end{figure}\label{fig:heatPlot_comparison}
...
\begin{figure}[h!]\label{fig:sigmafunction}
	\subfigure[]{
...
\begin{figure}[h!]\label{fig:optimSigma}
		\subfigure[]{
